	    ...
	    return true;
                    ...
                    <div class="col-md-8">
                        <div class="title inner-page-title">
	                        <h3>${requestScope.crAsgnTitle}</h3>
	                    </div>
	                    <form name="subAsgnWriteForm" action="${pageContext.request.contextPath}/cr/subAsgn/insert" method="post" enctype="multipart/form-data" onsubmit="return checkValid()">
	                        <div class="row">
	                            <div class="col-sm-12 ">
	                                ...
	                                <div class="form-group">
	                                    <label>과제내용 :</label>
	                                    <textarea rows="6" name="crSubasgnContent" class="form-control" placeholder="content" style="height: 400px;"></textarea>
	                                </div>
	                                <div class="form-group">
